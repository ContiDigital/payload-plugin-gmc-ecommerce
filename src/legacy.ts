/**
 * Legacy 1.x plugin surface. New installations must use the v2 root export.
 * This entrypoint exists only to support an explicit, temporary migration.
 */
...
export const payloadGmcEcommerceLegacy =
...
/** @deprecated Import `payloadGmcEcommerce` from the package root for v2. */
export const payloadGmcEcommerce = payloadGmcEcommerceLegacy
...
export default payloadGmcEcommerceLegacy
